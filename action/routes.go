...
import (
	...
	"github.com/factly/mande-server/action/cart"
	"github.com/factly/mande-server/action/catalog"
	...
	"github.com/factly/mande-server/action/search"
	"github.com/factly/mande-server/action/tag"
	userList "github.com/factly/mande-server/action/user"
	"github.com/factly/mande-server/action/webhook"
	_ "github.com/factly/mande-server/docs" // docs is generated by Swag CLI, you have to import it.
...
func RegisterWebHookRoutes() http.Handler {
	r := GetCommonRouter()
